  ...
  return (
    <>
      ...
      <Section title="TextField (variants)">
        <TextField variant="box" label="Box" placeholder="box placeholder" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="line" label="Line" placeholder="line placeholder" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="big" label="Big" placeholder="big placeholder" value={text} onChange={(e) => setText(e.target.value)} />
      </Section>
